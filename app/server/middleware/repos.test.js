...
describe('repos.js', () => {
    ...
    describe('listReposLinks', () => {
        ...
        it('if user does not have "admin" permission on repo, "edit-user-permission" link is not present', (done) => {
        ...
        it('if user has "admin" permission on repo, "edit-user-permission" link is present', (done) => {
